        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {isSignedIn ? (
              ...
              <button className="skapa-btn flex items-center justify-center bg-transparent border-2 bg-gray-300 font-semibold py-3 px-6 rounded-lg hover:bg-white transition duration-300">
